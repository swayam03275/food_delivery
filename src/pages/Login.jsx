  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 bg-white rounded-3xl shadow-xl p-10 md:p-16 max-w-2xl w-full">
        <h2 className="text-4xl font-bold text-center text-red-600 mb-2">Welcome Back</h2>
        ...
        <p className="mt-6 text-center text-gray-600 text-sm">
          ...
          <a href="/signup" className="text-red-600 hover:underline font-medium">Sign Up</a>
        </p>
      </div>
    </section>
  );
